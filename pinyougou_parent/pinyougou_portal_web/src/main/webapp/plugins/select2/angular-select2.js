 ...
 * @param {scope} spring 自定义配置
 * @param {String} [query] 内置的配置 (怎么也还得默认一个config)
 * @example
 * <input select2 ng-model="a" select2-model="b" spring="spring" type="text" placeholder="占位符" />
 * <input select2 ng-model="a" select2-model="b" spring="default" query="member" type="text" placeholder="占位符" />
