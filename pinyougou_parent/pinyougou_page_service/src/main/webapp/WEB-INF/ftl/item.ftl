    ...
    <script>
        ...
        var skuList=[
            <#list itemList as item>
                {
                    "id":${item.id?c},<#--将id转换为数字格式-->
                    "title":"${item.title!''}",<#--字符串需要加引号，对标题做非空校验-->
                    "price":${item.price?c},
                    "spec":${item.spec}<#--规格取出来是个json对象，-->
                },
...
<#--转换扩展属性的json字符串-->
<#assign customAttribute=goodsDesc.customAttributeItems?eval>
<#--转换规格列表的json字符串-->
<#assign sepcificationList=goodsDesc.specificationItems?eval>
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <#list sepcificationList as spec>
                            <dl>
                                <dt>
                                    <div class="fl title">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="#" target="_blank" ng-click="addCat()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
